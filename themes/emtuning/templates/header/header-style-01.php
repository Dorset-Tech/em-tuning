                                    ...
                                    <div class="meta-woo">
                                        ...
                                        <?php 
                                            ...
                                            <?php } else { global $current_user; wp_get_current_user();
                                                ?>
                                                <a class="myAcct" href="<?php echo esc_url( home_url( '/' ) ); ?>my-account/">
                                                    <img src="/wp-content/uploads/padlock-01.svg">
                                                <div class="accright">
                                        ...
                                        <div class="menu-item block-user block-woo">
                                            <a href="/wishlist/">
                                                ...
                                                <div class="cartright">
                                                    <?php  
                                                    	$wishlists = YITH_WCWL_Wishlist_Factory::get_current_wishlist(array('user_id'=>get_current_user_id()));
                                                    	
                                                    ?>
                                                    <label><?php echo do_shortcode('[yith_wcwl_items_count]'); ?> Items</label>
                                                    <span>Wishlist</span>
                                                </div>
                                            </a>
                                        </div>
